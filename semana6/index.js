...
//Igualdad
//Doble igual solo campara el valor
console.log(2 == "2");
//Triple igual compara el valor y el tipo de dato
console.log(2 === "2");
//Diferencia
//Un igual solo campara el valor
console.log("Diferente", 2 != "2");
//Doble igual compara el valor y el tipo de dato
console.log("Diferente", 2 !== "2");
...
//or = ó = ||
if(numero > 10 || numero < 20 || typeof numero === "number") {
    console.log("Este numero cumple alguna condición");
} else {
    console.log("No cumple las condiciones");
}
